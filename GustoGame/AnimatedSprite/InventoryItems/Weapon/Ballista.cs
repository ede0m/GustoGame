...
{
    public class Ballista : ShipMount
    {
        public Ballista(TeamType team, string region, Vector2 location, ContentManager content, GraphicsDevice graphics) : base(team, content, graphics)
        {
            ...
            Asset asset = new Asset(texture, textureBB, 4, 1, 1.0f, "ballista", region);

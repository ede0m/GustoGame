...
{
    public class Shovel : HandHeld
    {
        public Shovel(TeamType team, string region, Vector2 location, ContentManager content, GraphicsDevice graphics) : base(team, content, graphics)
        {
            ...
            Texture2D texture = content.Load<Texture2D>("Shovel");

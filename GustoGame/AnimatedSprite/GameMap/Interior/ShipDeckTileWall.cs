...
namespace Gusto.AnimatedSprite.GameMap
{
    ...
    {
        public ShipDeckTileWall(int index, List<Sprite> groundObjs, Vector2 location, string region, ContentManager content, GraphicsDevice graphics, string key) : base(index, groundObjs, content, graphics)
        {
